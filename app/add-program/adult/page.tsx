...
const PROGRAM_TYPES = [
  {
    key: 'team',
    label: 'Team',
    description: 'Adult squads',
    icon: UsersIcon,
    accent: '#001f3d',
    href: '/add-program/adult/team',
  },
  {
    key: 'league',
    label: 'League',
  ...
  },
  {
    ...
    icon: TrophyIcon,
    accent: '#123a55',
    href: '/add-program/adult/tournament',
  },
]

export default function AddAdultProgram() {
