...
const PROGRAM_TYPES = [
  {
    key: 'team',
    label: 'Team',
    description: 'Youth squads',
    icon: UsersIcon,
    accent: '#001f3d',
    href: '/add-program/youth/team',
  },
  {
    key: 'league',
    label: 'League',
  ...
  },
  {
    ...
    icon: TrophyIcon,
    accent: '#123a55',
    href: '/add-program/youth/tournament',
  },
]

export default function AddYouthProgram() {
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-lg text-[#345c72]/90 max-w-2xl mx-auto">
                Select the type of program you want to add
              </p>
            </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 max-w-6xl mx-auto">
              {PROGRAM_TYPES.map((program) => {
                ...
                return (
                  ...
                  >
                    <div className="absolute top-0 left-0 right-0 h-1" style={{ backgroundColor: program.accent }} />
                    ...
                    <div className="p-6 pt-8">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex-shrink-0 ml-4">
                          <div
                            className="w-10 h-10 rounded-xl flex items-center justify-center group-hover:bg-[#e87a00] group-hover:text-white transition-colors"
                            style={{ backgroundColor: `${program.accent}1A`, color: program.accent }}
                          >
                            <Icon />
                          </div>
                        </div>
