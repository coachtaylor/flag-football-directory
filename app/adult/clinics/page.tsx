...
export default async function AdultClinicsPage({ searchParams }: { searchParams?: SearchParams }) {
  ...
  let eQ = supabase
    .from('events')
    .select('id, slug, name, location, state, start_date, end_date, website, signup_url, cover_url, verified, divisions')
    .eq('kind', 'clinic')
  ...
  if (error) {
    console.error('[adult-clinics] query failed', error)
  }
    ...
    <div className="min-h-screen bg-gray-50">
      <section className="relative w-full overflow-hidden bg-gradient-to-br from-gray-50 via-white to-orange-50/30">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-20 pt-6 sm:px-8 lg:px-12">
          <div className="mb-6">
            <Breadcrumbs items={[{ label: 'Adult', href: '/adult' }, { label: 'Clinics' }]} className="py-0 text-sm text-[#345c72]" />
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <p className="max-w-2xl text-lg leading-relaxed text-[#345c72] sm:text-xl">
                  Find adult-focused development sessions, position clinics, and combine prep events with current registration details.
                </p>
              </div>
      ...
      <section className="relative w-full bg-gray-50">
        ...
        <div className="mx-auto max-w-7xl px-6 py-12 sm:px-8 lg:px-12">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 className="text-2xl font-semibold text-[#001f3d] sm:text-3xl">Clinics matching your filters</h2>
          ...
          {results.length > 0 ? (
            <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3 justify-items-center">
              {results.map((clinic: any) => {
                const { city, state: derivedState } = normalizeLocation(clinic.location, clinic.state)
                return (
                  <div key={clinic.id} className="w-full max-w-sm">
                    <OrgCard
                      o={{
                        ...
                        city_name: city,
                        state: derivedState || clinic.state || null,
            ...
            <div className="mt-12 rounded-3xl border border-[#001f3d]/15 bg-gradient-to-br from-white via-orange-50/20 to-blue-50/10 px-8 py-14 text-center shadow-lg shadow-[#001f3d]/10">
              ...
              <h3 className="mt-6 text-2xl font-semibold text-[#001f3d]">No adult clinics found</h3>
              <p className="mt-3 text-base text-[#345c72]/90">
                Try adjusting your search or expanding to additional states to see more coaching sessions.
              </p>
              <a
                href="/adult/clinics"
