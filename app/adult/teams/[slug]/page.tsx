...
const isAdultTeam = (team: any) => Array.isArray(team?.age_groups) && team.age_groups.includes('ADULT')

export default async function AdultTeamDetail({ params }: { params: { slug: string } }) {
  ...
  if (!team || !isAdultTeam(team)) {
    if (!team) {
      console.warn('[adult-team] missing team for slug', params.slug)
    }
    return (
          ...
          <div className="relative mx-auto max-w-7xl px-6 pb-20 pt-4 sm:px-8 lg:px-12">
            ...
            <div className="rounded-3xl border border-[#001f3d]/15 bg-[#f6f7fa] px-8 py-14 text-center shadow-[0_18px_45px_-32px_rgba(0,31,61,0.25)]">
              ...
              <p className="mt-3 text-base text-[#345c72]/90">
                The team you&apos;re looking for doesn&apos;t exist, hasn&apos;t been published yet, or isn&apos;t flagged as an adult program.
              </p>
              <a
                href="/adult/teams"
        ...
        <div className="mx-auto max-w-7xl px-6 py-12 sm:px-8 lg:px-12">
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <aside className="space-y-6">
              <section className="rounded-3xl border border-[#001f3d]/10 bg-white p-6 shadow-[0_16px_40px_-28px_rgba(0,31,61,0.45)]">
                <h3 className="text-lg font-semibold text-[#001f3d] mb-4">Adult Team Details</h3>
