          ...
          <div className="space-y-10">
            <div className="space-y-6">
              ...
              <div className="space-y-5">
                <h1 className="text-4xl font-semibold tracking-tight text-[#001f3d] sm:text-5xl xl:text-[3.25rem] xl:leading-[1.1]">
                  Compare verified flag football teams and build the right roster
                </h1>
            ...
            >
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5">
                ...
                <select
                  className="w-full rounded-2xl border border-[#001f3d]/15 bg-white px-3 py-3 text-sm font-medium text-[#001f3d] capitalize focus:border-[#e87a00] focus:outline-none focus:ring-2 focus:ring-[#e87a00]/25"
                  name="gender"
                  defaultValue={gender}
                >
      ...
      <section className="relative w-full bg-gray-50">
        ...
        <div className="mx-auto max-w-7xl px-6 py-12 sm:px-8 lg:px-12">
          ...
          {results.length > 0 ? (
            ...
            <div className="mt-12 rounded-3xl border border-[#001f3d]/15 bg-[#f6f7fa] px-8 py-14 text-center shadow-[0_18px_45px_-32px_rgba(0,31,61,0.25)]">
