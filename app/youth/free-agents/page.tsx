...
export default function YouthFreeAgentsPage() {
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg text-gray-600 max-w-3xl">
                Connect with young flag football players looking to join teams, leagues, or tournaments.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              {(filters.state || filters.gender || filters.skillLevel || filters.position || filters.ageGroup) && (
                <button
                  onClick={() => setFilters({ state: '', gender: '', skillLevel: '', position: '', ageGroup: '' })}
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 mb-6">
              {filters.state || filters.gender || filters.skillLevel || filters.position || filters.ageGroup
                ...
                : 'Be the first youth player to list yourself as a free agent!'}
            </p>
            <Link
                ...
                >
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="flex items-center gap-2 pt-2 border-t border-gray-100">
                      ...
                      <Link
                        href={`/youth/free-agents/${agent.id}`}
