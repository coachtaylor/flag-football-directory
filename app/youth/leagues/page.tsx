    ...
    <div className="min-h-screen bg-gray-50">
      <section className="relative w-full overflow-hidden bg-gradient-to-br from-gray-50 via-white to-orange-50/30">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-20 pt-6 sm:px-8 lg:px-12">
          <div className="mb-6">
            <Breadcrumbs items={[{ label: 'Youth' }, { label: 'Leagues' }]} className="py-0 text-sm text-[#345c72]" />
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-12 sm:px-8 lg:px-12">
          ...
          {leagues && leagues.length > 0 ? (
            ...
            <div className="mt-12 rounded-3xl border border-[#001f3d]/15 bg-gradient-to-br from-white via-orange-50/20 to-blue-50/10 px-8 py-14 text-center shadow-lg shadow-[#001f3d]/10">
              ...
              <a href="/youth/leagues" className="mt-6 inline-flex items-center justify-center rounded-2xl border border-[#001f3d]/15 bg-gradient-to-r from-white to-orange-50/30 px-5 py-3 text-sm font-semibold text-[#001f3d] shadow-sm transition hover:border-[#e87a00] hover:text-[#e87a00] hover:shadow-md">
                Clear Filters
              </a>
            </div>
          )}
...
function LeagueCard({ league }: { league: any }) {
  ...
  const href = slugOrId ? `/youth/leagues/${slugOrId}` : '/youth/leagues'
